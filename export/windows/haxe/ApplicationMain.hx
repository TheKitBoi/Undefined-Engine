...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("undefinedgame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("undefinedgame", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "undefinedgame";
		app.meta["name"] = "FNF: Undefinined Engine";
