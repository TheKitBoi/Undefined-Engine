...
HX_DEFINE_STACK_FRAME(_hx_pos_0326d48ecb40dd71_240_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/sys/thread/EventLoop.hx",240,0x8d9e56e7)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_0326d48ecb40dd71_240_new)
