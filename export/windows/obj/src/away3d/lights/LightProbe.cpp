...
HXDLIN(  83)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Object projection matrices are not supported for LightProbe objects!",5b,91,9f,e5),null())));
