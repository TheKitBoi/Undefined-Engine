...
HXLINE(  27)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Invalid size: Width and height must be power of 2 and cannot exceed 2048",ca,7f,98,7d),null())));
            		}
...
HXLINE(  40)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Invalid size: Width and height must be power of 2 and cannot exceed 2048",ca,7f,98,7d),null())));
            		}
