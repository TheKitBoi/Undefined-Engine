...
HXDLIN( 354)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::away3d::errors::AbstractMethodError_obj::__alloc( HX_CTX ,null(),null())));
            	}
...
HXDLIN( 362)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::away3d::errors::AbstractMethodError_obj::__alloc( HX_CTX ,null(),null())));
...
HXDLIN( 371)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::away3d::errors::AbstractMethodError_obj::__alloc( HX_CTX ,null(),null())));
...
HXLINE( 408)			goto _hx_goto_37;
            		...
            		/* default */{
HXLINE( 413)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("Unsupported blend mode!",44,ce,40,e2))));
            		}
            		_hx_goto_37:;
            	}
