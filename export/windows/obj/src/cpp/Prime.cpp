...
HX_LOCAL_STACK_FRAME(_hx_pos_e7e3b9ab97b87e2e_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/Prime.hx",34,0xeeae3fa7)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_e7e3b9ab97b87e2e_34__loadPrime)
