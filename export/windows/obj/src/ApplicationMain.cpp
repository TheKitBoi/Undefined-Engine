...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("undefinedgame",82,ba,13,f0),::ApplicationMain_obj::create_dyn());
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FNF: Undefinined Engine",f1,ed,4b,1a))
