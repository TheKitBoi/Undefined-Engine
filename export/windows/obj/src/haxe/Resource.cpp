...
HX_LOCAL_STACK_FRAME(_hx_pos_498056a98820b0de_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/haxe/Resource.hx",35,0x17d5204a)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_498056a98820b0de_35_getBytes)
