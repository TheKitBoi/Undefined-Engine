...
HX_LOCAL_STACK_FRAME(_hx_pos_1ea9e16be5828acf_47_writeByte,"haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/io/Output.hx",47,0x43fd8be1)
HX_LOCAL_STACK_FRAME(_hx_pos_1ea9e16be5828acf_57_writeBytes,"haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/io/Output.hx",57,0x43fd8be1)
HX_LOCAL_STACK_FRAME(_hx_pos_1ea9e16be5828acf_92_close,"haxe.io.Output","close",0xe726bfeb,"haxe.io.Output.close","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/io/Output.hx",92,0x43fd8be1)
HX_LOCAL_STACK_FRAME(_hx_pos_1ea9e16be5828acf_121_writeFullBytes,"haxe.io.Output","writeFullBytes",0xc2c420ea,"haxe.io.Output.writeFullBytes","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/io/Output.hx",121,0x43fd8be1)
HX_LOCAL_STACK_FRAME(_hx_pos_1ea9e16be5828acf_278_writeString,"haxe.io.Output","writeString",0x97e1cb83,"haxe.io.Output.writeString","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/io/Output.hx",278,0x43fd8be1)
namespace haxe{
namespace io{
...
void Output_obj::writeByte(int c){
            	HX_GC_STACKFRAME(&_hx_pos_1ea9e16be5828acf_47_writeByte)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_1ea9e16be5828acf_57_writeBytes)
...
void Output_obj::close(){
            	HX_STACKFRAME(&_hx_pos_1ea9e16be5828acf_92_close)
            	}
...
void Output_obj::writeFullBytes( ::haxe::io::Bytes s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_1ea9e16be5828acf_121_writeFullBytes)
...
void Output_obj::writeString(::String s, ::haxe::io::Encoding encoding){
            	HX_STACKFRAME(&_hx_pos_1ea9e16be5828acf_278_writeString)
