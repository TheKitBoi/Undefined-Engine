...
HX_DEFINE_STACK_FRAME(_hx_pos_f484fb71c809a5e8_252_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/ds/BalancedTree.hx",252,0xbcf98765)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,::hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_f484fb71c809a5e8_252_new)
