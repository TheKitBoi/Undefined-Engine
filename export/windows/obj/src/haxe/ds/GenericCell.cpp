...
HX_DEFINE_STACK_FRAME(_hx_pos_97bed8a403664ed7_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/ds/GenericStack.hx",37,0x99db8fda)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_97bed8a403664ed7_37_new)
