...
HX_DEFINE_STACK_FRAME(_hx_pos_d39ce164a9719576_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/haxe/ds/List.hx",266,0xaee19a4d)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_d39ce164a9719576_266_new)
