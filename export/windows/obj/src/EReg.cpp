...
HX_DEFINE_STACK_FRAME(_hx_pos_c51a083de245d919_28_new,"EReg","new",0x8b859e81,"EReg.new","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",28,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_36_match,"EReg","match",0x18fda1a6,"EReg.match","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",36,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_45_matched,"EReg","matched",0x8ce62f85,"EReg.matched","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",45,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_62_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",62,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_65_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",65,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_74_split,"EReg","split",0x9749433b,"EReg.split","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",74,0xab7bcc0c)
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_98_replace,"EReg","replace",0xae923ad5,"EReg.replace","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",98,0xab7bcc0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c51a083de245d919_149_map,"EReg","map",0x8b84d8bd,"EReg.map","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/cpp/_std/EReg.hx",149,0xab7bcc0c)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_28_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_36_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_45_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_62_matchedPos)
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_c51a083de245d919_74_split)
HXLINE(  75)		int pos = 0;
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_c51a083de245d919_98_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_c51a083de245d919_149_map)
