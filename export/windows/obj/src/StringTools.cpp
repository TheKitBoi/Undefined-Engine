...
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_50_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",50,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_118_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",118,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_158_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",158,0x1c63d990)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_194_htmlUnescape,"StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",194,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_238_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",238,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_249_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",249,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_278_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",278,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_296_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",296,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_321_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",321,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_349_trim,"StringTools","trim",0x2908d066,"StringTools.trim","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",349,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_365_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",365,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_424_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",424,0x1c63d990)
HX_LOCAL_STACK_FRAME(_hx_pos_5835ebce075d8d8d_434_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","C:\\bin\\winBin\\haxe_20201231082044_5e33a78aa\\haxe\\std/StringTools.hx",434,0x1c63d990)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_50_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_118_urlDecode)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_GC_STACKFRAME(&_hx_pos_5835ebce075d8d8d_158_htmlEscape)
...
::String StringTools_obj::htmlUnescape(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_194_htmlUnescape)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_238_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_249_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_278_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_296_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_321_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_349_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_5835ebce075d8d8d_365_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_424_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_5835ebce075d8d8d_434_hex)
